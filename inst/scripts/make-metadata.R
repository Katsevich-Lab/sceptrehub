...
metadata <- data.frame(Title = c("High multiplicity-of-infection CRISPRi screen of putative enhancers (cell ranger format)",
                       ...
                       SourceVersion = c(rep("01-04-2019", 2), "01-06-2024", "04-21-2024"),
                       ...
                       Maintainer = rep("tbarry@hsph.harvard.edu", 4),
                       RDataClass = c("Matrix", "list", "list", "Matrix"),
                       DispatchClass = c("FilePath", "Rda", "Rda", "FilePath"),
                       Location_Prefix = rep("https://zenodo.org/", 4),
                       RDataPath = c("records/10999688/files/highmoi_example.zip",
                                     "records/10999688/files/highmoi_example_data.rda",
                                     "records/10999688/files/lowmoi_example_data.rda",
                                     "records/10999688/files/parse_example.zip"),
